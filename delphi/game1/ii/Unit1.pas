...
begin
  ...
  while ii<100 do
   begin
     try
     s:=Form1.idhtp1.Get('http://sergalru.esy.es/server.php?s='+ FloatToStr(playerx+vectorx+x0)+'_'+ FloatToStr(playery+vectory+y0));
     if ii<100 then
     s:=Form1.idhtp1.Get('http://sergalru.esy.es/cursorpos2.in');
